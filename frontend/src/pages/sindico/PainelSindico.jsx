                    ...
                    <li>
                        <button className={abaAtiva === "solicitacoes" ? "ativo" : ""} onClick={() => setAbaAtiva("solicitacoes")}>
                            ...
                            {solicitacoes.filter(s => s.status === "PENDENTE").length > 0 && (
                                <span style={{
                                    marginLeft: "8px", background: "#e67e22", color: "white",
                                    borderRadius: "10px", padding: "1px 8px", fontSize: "0.75rem", fontWeight: "bold"
                                }}>
                ...
                <div className="corpo-sindico">
                    {carregando ? (
                        ...
                        <>
                            ...
                            {abaAtiva === "moradores" && (
                                <SindicoMoradores moradores={moradores} />
                            )}
                            {abaAtiva === "unidades" && (
                                <SindicoUnidades
                            ...
                            {abaAtiva === "reclamacoes" && (
                                <SindicoReclamacoes
                                    reclamacoes={reclamacoes} setReclamacoes={setReclamacoes}
                                    api={api} toast={toast} formatarData={formatarData}
                                />
                            )}
                            {abaAtiva === "avisos" && (
                                <SindicoAvisos
                                    avisos={avisos} setAvisos={setAvisos}
                                    perfil={perfil} api={api} toast={toast}
                                    formatarData={formatarData}
                                />
                            )}
                            {abaAtiva === "documentos" && (
                            ...
                            {abaAtiva === "minhas-reservas" && (
                                <SindicoReservas api={api} toast={toast} />
                            )}
                            {abaAtiva === "meu-perfil" && (
                                <SindicoMeuPerfil
                                    meuNome={meuNome}
